//api and recaptcha - WESTMORELAND COUNTY COMMUNITY COLLEGE - STAGING
// Configuration for STAGING environment
// Points to staging API: westmoreland-staging-api.schoolvision.io

// ========================================
// API ENDPOINTS - STAGING
// ========================================
window.VUE_CONFIG_API = "https://westmoreland-staging-api.schoolvision.io/westmoreland/api/"
window.VUE_CONFIG_API_IMAGE = "https://westmoreland-staging-api.schoolvision.io/westmoreland/api/"
window.VUE_CONFIG_API_ECOMMERCE = "https://westmoreland-staging-api.schoolvision.io/westmoreland/api/ecommerce/"
...
// ========================================
// PROMO BANNER - STAGING INDICATOR
// ========================================
window.PROMO_BANNER_ENABLED = true
window.PROMO_BANNER_TEXT = 'STAGING ENVIRONMENT - Testing Only'
window.PROMO_BANNER_BG = '#d9534f' // Red to indicate staging
