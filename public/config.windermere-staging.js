//api and recaptcha - WINDERMERE PREPARATORY SCHOOL - STAGING
// Configuration for STAGING environment
// Points to Azure test API for staging
// Color scheme based on school branding: Navy blue, white, and teal accents

// ========================================
// API ENDPOINTS - STAGING (Azure Test)
// ========================================
window.VUE_CONFIG_API = "https://paymentapi-ecommerce-test-v2.azurewebsites.net/windermere/api/"
window.VUE_CONFIG_API_IMAGE = "https://paymentapi-ecommerce-test-v2.azurewebsites.net/windermere/api/"
window.VUE_CONFIG_API_ECOMMERCE = "https://paymentapi-ecommerce-test-v2.azurewebsites.net/windermere/api/ecommerce/"
